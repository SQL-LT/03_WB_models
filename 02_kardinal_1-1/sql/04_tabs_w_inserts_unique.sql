...
CREATE TABLE IF NOT EXISTS `mydb`.`servants` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_servants_cats_idx` (`cats_id` ASC), -- omitt VISIBLE,
  UNIQUE INDEX `cats_id_UNIQUE` (`cats_id` ASC), -- omitt VISIBLE, UNIQUE INDEX added
...
-- Inhalte: DT
INSERT INTO `mydb`.`servants` (`id`, `servant_name`, `yrs_served`, `cats_id`) VALUES (DEFAULT, "Peter", 5, 1); -- Fehler!
